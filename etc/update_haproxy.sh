...
main() {
	haproxy_cname=$1
	cp haproxy.cfg.template $destination_file
	update_http_servers
	update_pg_servers
	update_ldap_servers
...
# HTTP backend info is generated by http_servers.sh
...
# PG backend info is generated by pg_servers.sh
...
# LDAP backend info is generated by ldap_servers.sh
